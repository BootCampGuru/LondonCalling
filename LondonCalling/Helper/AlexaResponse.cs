...
namespace LondonCalling.Helper
{
    ...
    public class AlexaResponse
    {
        ...
        public AlexaResponse(string outputSpeechText, bool shouldEndSession, string ssml = "", string card = "")
            : this()
        {

            Response.ShouldEndSession = shouldEndSession;
            if (ssml != string.Empty)
            {
            ...
            // Response.Reprompt.OutputSpeech.Text = card;
